<template>
    <div class="container">
        ...
        <div class="tabs">
            ...
            >
                전체 ({{ totalCount }}) <br /><span class="totalAmount">{{
            ...
            >
                수입 ({{ incomeCount }})<br /><span class="incomeAmount">{{
            ...
            >
                지출 ({{ expenseCount }})<br /><span class="expenseAmount">{{
        ...
        <div class="table">
            ...
            >
                ...
                <div
                    :class="['amount', item.type === '수입' ? 'plus' : 'minus']"
                >
...
const filteredList = computed(() => {
    ...
    return list.value.filter((item) => {
        ...
        const tabMatch =
            activeTab.value === "전체" ? true : item.type === activeTab.value;
