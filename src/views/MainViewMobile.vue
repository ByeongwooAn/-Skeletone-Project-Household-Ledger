...
<template>
    ...
    <div id="mobile-main-div3" class="mobile-mainview-div">
        ...
        <div id="mobile-main-deal-report1" class="mobile-main-attribute-div">
            거래 내역1
        </div>
        <div id="mobile-main-deal-report2" class="mobile-main-attribute-div">
            거래 내역2
        </div>
        <div id="mobile-main-deal-report3" class="mobile-main-attribute-div">
            거래 내역3
        </div>
        <div id="mobile-main-deal-report4" class="mobile-main-attribute-div">
            거래 내역4
        </div>
        <div id="mobile-main-deal-report5" class="mobile-main-attribute-div">
            거래 내역5
        </div>
    </div>
